import extend from 'utils/core/extend';
import events from 'utils/core/events';
...
(function () {
	...
	var testAutoplay = function (event) {
		clearTimeout(timeout);
		elem.removeEventListener('playing', testAutoplay);
		autoplay.isSupported = (event && event.type === 'playing') || elem.currentTime !== 0;
		elem.parentNode.removeChild(elem);
		autoplay.checked = true;
		autoplay.trigger('ready');
	};

	elemStyle.height = 0;
	elemStyle.width = 0;

	var h264Support = '' !== (elem.canPlayType('video/mp4; codecs="avc1.42E01E"' ) || elem.canPlayType( 'video/mp4; codecs="avc1.42E01E, mp4a.40.2"'));
