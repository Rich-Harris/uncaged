...
define('ractive_components/clock',[
	"require",
	"ractive"
], function(
	require,
...
define('ractive_components/header',[
	"require",
	"ractive"
], function(
	require,
...
var __options__ = {
	template: {v:1,t:[{t:7,e:"h1",f:["success!"]}," ",{t:7,e:"p",f:["The ${name} project has been created."]}]},
},
component={},
__prop__,
...
define('ractive_components/base',[
	"./clock",
	"./header",
	"require",
	"ractive"
...
define(
  'app',["data","ractive_components/base"],
